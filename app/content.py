...
BLOCKS = {
 "assumptions": {
  ...
  "assets": [("Assumption governance assets — live in the workspace", "folder:02_assumption_governance"),
             ...
             ("Maker: draft + submit a basis (job)", "job:lifecast_assumption_entry"),
             ("Checker: approve or reject (job)", "job:lifecast_assumption_approval")],
 ...
 "scenarios": {
  ...
  "assets": [("Scenario management assets — live in the workspace", "folder:04_scenario_management"),
             ...
             ("Ingest a vendor delivery through the gate (job)", "job:lifecast_scenario_ingest"),
             ("The illustrative generator — EIOPA curve → QuantLib (job)", "job:lifecast_esg_illustrative"),
